...
import Table1EditPage from 'pages/table1/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
const Table1ViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<Table1EditPage isSubPage apiPath={`/table1/edit/${data.id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="Table1ViewPage" className="main-page">
    { (props.showHeader) && 
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">Nombre</div>
...
Table1ViewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'table1',
	apiPath: 'table1/view',
	routeName: 'table1view',
